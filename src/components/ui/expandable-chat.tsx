...
const ExpandableChatToggle: React.FC<ExpandableChatToggleProps> = ({
  ...
  <Button
    ...
    onClick={toggleChat}
    className={cn(
      "w-14 h-14 rounded-full shadow-lg flex items-center justify-center hover:shadow-xl transition-all duration-300 bg-blue-600 hover:bg-blue-700 text-white border-2 border-blue-500",
      className,
    )}
    {...props}
  >
